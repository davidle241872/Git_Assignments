/*
after naming the table - CREATE TABLE {name for the table} 
you want to have colums within your table which is ID, todo, and completed 
name the length 

INSERT the name of the table(todo, completed)
*/
CREATE TABLE todos(
...
VALUES
('Go to gym', true),
('Take Protein shake', true),
('Drive to bootcamp', true);
...
INSERT INTO One_Piece(task, completed)
VALUES 
('Become a pirate', true),
('Gain more bounty', false),
