...
let artistTopTracks = [
    ...
    let newArtist = 0;
    let artists = {};
    for(let i = 0; i < artistData.lengths; i++) {
         newArtist = {
       // name:artistData[i].name,
       // genre:artistData[i].genres[0],
         }
        ...
        //         let newTopTracks = {
        //             topTracks: artistTopTracks[j].tracks[k].name,
        //             topTracks: artistTopTracks[j].tracks[k].topTracks,
                    
        //         }
        //         usefulArtists.push(newTopTracks)
       // topThreeTracks:artistData[i]
        // };
        // }

 usefulArtists.push(newArtist);
 //usefulArtists.push(newTopTracks);
    // }
    // for(let j = 0; j < artistData.length; j++){
    //     for(let k =0; k < 3; k++) {
